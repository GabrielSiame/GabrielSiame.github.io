...
<head>
    ...
    <title>Home | Yagi innovations Marketing Hub</title>
...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +260974503554</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> gabrielsiame8@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><img src="images/home/logo3.jpg" alt="" /></a>
            </div> 
          </div>
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span>YAGI'S</span>Marketing Hub</h2>
              <p>we are here to serve you and offering magical services</p>
            </div>
          </div>
          <div class="col-sm-7">
            <div class="col-sm-6">
          ...
          <div class="col-sm-3">
            <div class="address">
              ...
              <p>starting from lusaka and kabwe to other parts of the country and international</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footer-widget">
      <div class="container">
        <p>You are welcome to the quick access</p>
        <div class="row">
          <div class="col-sm-3">
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Modified by <span><a href="#">Gabriel siame</a></span></p>
          <p class="pull-right">Designed by <span><a target="_blank" href="#">Mr Simzz</a></span></p>
        </div>
      </div>
    </div>
