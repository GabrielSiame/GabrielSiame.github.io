      ...
      <div class="table-responsive cart_info"> 
              ...
              ?>
                         ...
                         <!-- <td></td> -->
                          ...
                          <td>k <?php echo  $result->PRODISPRICE ?></td>
                          <td>k <output><?php echo $_SESSION['gcCart'][$i]['price']?></output></td>
                        </tr>
              <?php
              ...
              ?>
                ...
                <div class="  pull-right">
                  <p align="right">
                  <div > Total Price :   k <span id="sum">0.00</span></div>
                   <div > Delivery Fee : k <span id="fee">0.00</span></div>
                   <div> Overall Price : k <span id="overall"><?php echo $tot ;?></span></div>
