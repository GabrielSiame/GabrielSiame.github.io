				 ...
				 $subtot=0;
				  $query = "SELECT * 
						...
						echo '<tr>';  
				  		...
				  		echo '<td> k '. number_format($result->PROPRICE,2).' </td>';
				  		echo '<td align="center" >'. $result->ORDEREDQTY.'</td>';
				  		?>
				  		 <td> k <output><?php echo  number_format($result->ORDEREDPRICE,2); ?></output></td> 
				  		<?php
		...
		?>
 		...
 		<div class="row">
		  	...
		  	<div class="col-md-6 pull-right">
		  		<p align="right">Total Price : k <?php echo number_format($subtot,2);?></p>
		  		<p align="right">Delivery Fee : k <?php echo number_format($price,2); ?></p>
		  		<p align="right">Overall Price : k <?php echo number_format($cur->PAYMENT,2); ?></p>
		  	</div>
		  </div>
		  ...
		  <div class="row">
		  	  ...
		  	  <p>Sincerely.</p>
		  	  <h4><a href="https://bit.ly/2LPn9Wu">YAGI innovations Marketing Hub</a></h4>
		  </div>
		  <?php }?>
  </div> 
